...
public class ResourceType extends Entity{
	 ...
	 */
	public ResourceType(int newID, String newTypeName, String newTitleLabel, String newCreatorLabel, String newCompanyLabel, String newSerialNumberLabel, int newStaffPeriod, int newFacultyPeriod, int newStudentPeriod, boolean newEnabled){
		super(newID);
