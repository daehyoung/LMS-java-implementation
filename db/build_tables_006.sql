...
CREATE  TABLE IF NOT EXISTS `librisDB`.`user` (
  `user_ID` INT NOT NULL DEFAULT 100000000 ,
...
CREATE  TABLE IF NOT EXISTS `librisDB`.`toDo` (
  ...
  PRIMARY KEY (`todo_ID`) ,
  INDEX `fk_toDo_user_idx` (`user_user_ID` ASC) ,
...
-- -----------------------------------------------------
-- Table `librisDB`.`creator`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `librisDB`.`creator` ;

CREATE  TABLE IF NOT EXISTS `librisDB`.`creator` (
...
-- -----------------------------------------------------
-- Table `librisDB`.`creatorHasResource`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `librisDB`.`creatorHasResource` ;

CREATE  TABLE IF NOT EXISTS `librisDB`.`creatorHasResource` (
  `creator_creator_ID` INT NOT NULL ,
  `resource_resource_ID` INT NOT NULL ,
  PRIMARY KEY (`creator_creator_ID`, `resource_resource_ID`) ,
  INDEX `fk_creator_has_resource_resource1_idx` (`resource_resource_ID` ASC) ,
  INDEX `fk_creator_has_resource_creator1_idx` (`creator_creator_ID` ASC) ,
  CONSTRAINT `fk_creator_has_resource_creator1`
    FOREIGN KEY (`creator_creator_ID` )
    REFERENCES `librisDB`.`creator` (`creator_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_creator_has_resource_resource1`
    FOREIGN KEY (`resource_resource_ID` )
    REFERENCES `librisDB`.`resource` (`resource_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
