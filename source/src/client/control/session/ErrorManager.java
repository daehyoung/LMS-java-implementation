...
public class ErrorManager{
	...
	/**
	 * Requests confirmation from the user for the given message
	 * 
	 * @param message The message to get confirmation for
	 * @return True if the user confirms, false otherwise
	 */
	public static boolean getConfirmation(String message){
		int choice = JOptionPane.showConfirmDialog(null, message, "Please Confirm", JOptionPane.YES_NO_OPTION);
		if(choice == JOptionPane.YES_OPTION)
			return true;
		return false;
	}
