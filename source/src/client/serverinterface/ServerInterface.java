...
public class ServerInterface {
	...
	private ServerInterface(String serverIP, int port) throws ConnectException{
	 ...
	 */
	public static synchronized ServerInterface configureServerInterface(String serverIP,int port) throws ConnectException {
	...
	public void connect() throws ConnectException{
		if(connection != null)
			connection.close();
		connection = new NetworkConnection(serverIP,serverPort);
		connection.configure();
	}
	
	/**
	 * Closes the connection to the server gracefully
	 * @throws ConnectException If the connection to the server timed out.
	 * 
	 */
	 ...
	 * @throws ConnectException If the connection to the server timed out.
	 */
	public CachedRowSetImpl requestSelect(String sqlSelect) throws RequestException, ConnectException {
		RequestPacket request = new RequestPacket();
	 ...
	 * @throws ConnectException If the connection to the server timed out.
	 */
	public CachedRowSetImpl requestSelect(String sqlSelect, String sqlCheck[]) throws RequestException, ConnectException {
		RequestPacket request = new RequestPacket();
		request.setPacketType(RequestPacket.REQUEST_SQL);
		request.setSQLType(RequestPacket.SELECT);
		request.setSQLStatment(sqlSelect);
	 ...
	 * @throws ConnectException If the connection to the server timed out.
	 */
	public int requestInsert(String sqlInsert) throws RequestException, ConnectException {
		RequestPacket request = new RequestPacket();
		request.setPacketType(RequestPacket.REQUEST_SQL);
	 ...
	 * @throws ConnectException If the connection to the server timed out.
	 */
	public int requestInsert(String sqlInsert, String sqlCheck[]) throws RequestException, ConnectException {
		RequestPacket request = new RequestPacket();
		request.setPacketType(RequestPacket.REQUEST_SQL);
		request.setSQLType(RequestPacket.INSERT);
		request.setSQLStatment(sqlInsert);
	 ...
	 * @throws ConnectException If the connection to the server timed out.
	 */
	public boolean requestUpdate(String sqlUpdate) throws RequestException, ConnectException{
		RequestPacket request = new RequestPacket();
		request.setPacketType(RequestPacket.REQUEST_SQL);
	 ...
	 * @throws ConnectException If the connection to the server timed out.
	 */
	public boolean requestUpdate(String sqlUpdate, String sqlCheck[]) throws RequestException, ConnectException{
		RequestPacket request = new RequestPacket();
		request.setPacketType(RequestPacket.REQUEST_SQL);
		request.setSQLType(RequestPacket.UPDATE);
		request.setSQLStatment(sqlUpdate);
	 ...
	 * @throws ConnectException If the connection to the server timed out.
	 */
	public boolean requestDelete(String sqlDelete) throws RequestException, ConnectException{
		RequestPacket request = new RequestPacket();
		request.setPacketType(RequestPacket.REQUEST_SQL);
	 ...
	 * @throws ConnectException If the connection to the server timed out.
	 */
	public boolean requestDelete(String sqlDelete, String sqlCheck[]) throws RequestException, ConnectException{
		RequestPacket request = new RequestPacket();
		request.setPacketType(RequestPacket.REQUEST_SQL);
		request.setSQLType(RequestPacket.DELETE);
		request.setSQLStatment(sqlDelete);
	 ...
	 * @throws ConnectException If the connection to the server timed out.
	 */
	public CachedRowSetImpl requestLogin(int userID, String userPassword) throws RequestException, ConnectException{
		RequestPacket request = new RequestPacket();
	 ...
	 * @throws ConnectException If the connection to the server timed out.
	 */
	public boolean requestLogout() throws RequestException, ConnectException{
		RequestPacket request = new RequestPacket();
	 ...
	 * @throws ConnectException If the connection to the server timed out.
	 */
	public boolean requestChangePassword(int userID, String userPassword, String newPassword) throws RequestException, ConnectException{
		RequestPacket request = new RequestPacket();
