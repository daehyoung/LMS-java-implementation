...
public class LoanList extends ListPanel {
	...
	private class UserTableModel extends AbstractTableModel {
		...
		// The column names
		private String[] columns = { "ID", "Check Out Date (" + Constants.DEFAULT_DATE_FORMAT.toUpperCase() + ")",
				"Check In Date (" + Constants.DEFAULT_DATE_FORMAT.toUpperCase() + ")",
				"Due Date (" + Constants.DEFAULT_DATE_FORMAT.toUpperCase() + ")", "Fine Amount ($)"};
