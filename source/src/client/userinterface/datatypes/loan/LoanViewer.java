...
public class LoanViewer extends JPanel {
	...
	private void createCheckOutDateText() {
		...
		textPane2.setBackground(Constants.BACKPANEL);
		textPane2.setText("(" + Constants.DEFAULT_DATE_FORMAT.toUpperCase() + ")");
		textPane2.setBounds(250, 60, 130, 20);
	...
	private void createCheckInDateText() {
		...
		textPane2.setBackground(Constants.BACKPANEL);
		textPane2.setText("(" + Constants.DEFAULT_DATE_FORMAT.toUpperCase() + ")");
		textPane2.setBounds(250, 90, 130, 20);
		textPane2.setEditable(false);
		textPane2.setFocusable(false);
		add(textPane2);
	}
	...
	private void createDueDateText() {
		...
		textPane2.setBackground(Constants.BACKPANEL);
		textPane2.setText("(" + Constants.DEFAULT_DATE_FORMAT.toUpperCase() + ")");
		textPane2.setBounds(250, 120, 130, 20);
		textPane2.setEditable(false);
		textPane2.setFocusable(false);
		add(textPane2);
	}
