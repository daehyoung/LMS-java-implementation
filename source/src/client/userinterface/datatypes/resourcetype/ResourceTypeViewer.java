...
public class ResourceTypeViewer extends JPanel {
	...
	private void createStaffPeriodInput() {
		...
		staffPeriodTextPane.setText("Staff Period (days):");
		staffPeriodTextPane.setBounds(40, 210, 140, 20);
	...
	private void createFacultyPeriodInput() {
		...
		facultyPeriodTextPane.setText("Faculty Period (days):");
		facultyPeriodTextPane.setBounds(40, 240, 140, 20);
	...
	private void createStudentPeriodInput() {
		...
		studentPeriodTextPane.setText("Student Period (days):");
		studentPeriodTextPane.setBounds(40, 270, 140, 20);
	...
	private void createMaxFineInput() {
		...
		maxFineInputField.setText(new DecimalFormat("0.00").format(resourceType.getMaxFineAmount()));
	...
	private void createFineIncrementInput() {
		...
		fineIncrementInputField.setText(new DecimalFormat("0.00").format(resourceType.getFineIncrementAmount()));
			...
			public void actionPerformed(ActionEvent event) {
				...
				try {
					...
					if (newResourceType) {
						...
						JOptionPane.showMessageDialog(mainWindow,
								"The resource type was successfully added",
						...
						resourceType = newResourceTypeEntity;
						JOptionPane.showMessageDialog(mainWindow,
								"The resource type was successfully changed",
					...
					JOptionPane.showMessageDialog(mainWindow,
	                        "Only digits allowed for loan periods and fine values.",
	                        "Error",
	                        JOptionPane.ERROR_MESSAGE);
				}
			}
