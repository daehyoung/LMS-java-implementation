...
public class SubscriptionViewer extends JPanel {
	...
	private void createEmailInput()
	{
		...
		emailAddressTextPane.setText("example@noreply.com");
		emailAddressTextPane.setBounds(330, 150, 150, 20);
			...
			public void actionPerformed(ActionEvent event) {
				try {
					...
					if (newSub) {
						...
						JOptionPane.showMessageDialog(mainWindow,
								"The subscription was successfully added",
						...
						subscription = newSubscriptionEntity;
						JOptionPane.showMessageDialog(mainWindow,
								"The subscription was successfully changed",
