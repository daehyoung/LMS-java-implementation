...
public class UserInformationTab extends JPanel {
	...
	private void createEmailAddressInput() {
		...
		JTextPane emailAddressTextPane2 = new JTextPane();
		emailAddressTextPane2.setBackground(Constants.BACKPANEL);
		emailAddressTextPane2.setText("example@noreply.com");
		emailAddressTextPane2.setBounds(340, 150, 150, 20);
		emailAddressTextPane2.setEditable(false);
		emailAddressTextPane2.setFocusable(false);
		add(emailAddressTextPane2);
	...
	private void save() {
		...
		if (newUser == true) {
			...
			// Display successful message
			JOptionPane.showMessageDialog(mainWindow,
					"The user was successfully changed",
