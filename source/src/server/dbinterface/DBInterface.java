...
public class DBInterface {
	 ...
	 */
	public static synchronized DBInterface getReference(){
		if(singleton == null)
			ErrorManager.getReference().fatalSubsystemError(new InstantiationException("DBInterface hasn't been initialized yet!"), singleton);
		return singleton;
	}
